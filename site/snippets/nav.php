...
<div class="Nav__content has-width-100 is-fixed has-height-100 is-flex is-center">
  <div class="container has-width-100 is-flex is-center-y">
    <ul class="is-column has-mr-1 is-4 Nav__menu">
    <?php foreach($site->pages()->listed() as $page): ?>
      <li><a href="<?= $page->url() ?>"><?= $page->title() ?></a></li>
    <?php endforeach; ?>
    </ul>
    <div class="Nav__categories is-column is-7 is-flex is-wrap is-right-x">
