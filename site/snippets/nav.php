...
<div class="Nav__content has-width-100 is-fixed has-height-100 is-flex is-center" hidden>
  <div class="Nav__scroller container has-width-100 is-flex is-center-y is-wrap">
    <ul class="Nav__menu is-column has-mr-1 is-4 is-12-phone">
    <?php foreach($site->pages()->listed() as $page): ?>
      <li><a href="<?= $page->url() ?>"><?= $page->title() ?></a></li>
    <?php endforeach; ?>
    </ul>
    <div class="Nav__categories is-column is-7 is-12-phone is-flex is-wrap is-right-x">

    <?php foreach($columns as $column): ?>
      <div class="is-column is-4 is-6-touch">
      <?php foreach($column as $category): ?>
        <ul>
          <li class="has-color-grey"><?= $category['title'] ?></li>
